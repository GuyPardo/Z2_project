...
def trotter_step_B_m(dt):
    trotter = [Id for _ in range(20)]
    trotter_all = Id
    ...
    for i in rangex:
        for j in rangey:
            if diagonal(i, j)[1] or diagonal(i, j)[3]:
                trotter[10] = trotter[10] * U(2, 1, ([i, j], 1), ([i, j], 0))
                trotter[10] = trotter[10] * U(2, 1, ([i-1, j], 0), ([i, j-1], 1))
    ...
    for i in rangex:
        for j in rangey:
            if diagonal(i, j)[0]:
                trotter[11] = trotter[11] * U(2, 1, ([i-1, j], 0), ([i, j], 1))
            if diagonal(i, j)[3]:
                trotter[11] = trotter[11] * U(2, 1, ([i, j-1], 1), ([i, j], 0))
    ...
    for i in rangex:
        for j in rangey:
            if diagonal(i, j)[0]:
                trotter[12] = trotter[12] * RZ(-dt * m, ([i,j],1))
            if diagonal(i, j)[3]:
                trotter[12] = trotter[12] * RZ(-dt * m, ([i, j], 0))
    ...
    for i in rangex:
        for j in rangey:
            ...
            if diagonal(i, j)[2]:
                trotter[14]= trotter[14] * U(2,1,([i, j], 1), ([i, j], 0))
                trotter[14] = trotter[14] * U(2, 1, ([i-1, j], 0), ([i, j-1], 1))
    ...
    for i in rangex:
        for j in rangey:
            if diagonal(i, j)[0]:
                trotter[15] = trotter[15] * U(0,2,([i, j-1], 1), ([i, j], 0))
            if diagonal(i, j)[3]:
                trotter[15] = trotter[15] * U(0,2,([i, j-1], 1), ([i, j], 0))
    ...
    for i in rangex:
        for j in rangey:
            if diagonal(i, j)[3]:
                trotter[16] = trotter[16] * RX(-2 * dt * lam_B, ([i, j], 0))
                trotter[16] = trotter[16] * RX(-2 * dt * lam_B, ([i - 1, j], 0))
    ...
    for i in rangex:
        for j in rangey:
            if diagonal(i, j)[0]:
                trotter[18] = trotter[18] * U(2,2,([i, j], 1), ([i, j], 0))
                trotter[18] = trotter[18] * U(2, 2, ([i-1, j], 0), ([i, j-1], 1))
            if diagonal(i, j)[2]:
                trotter[18] = trotter[18] * U(2,1,([i, j], 1), ([i, j], 0))
                trotter[18] = trotter[18] * U(2, 1, ([i-1, j], 0), ([i, j-1], 1))
    ...
    for i in rangex:
        for j in rangey:
            if diagonal(i, j)[3]:
                trotter[19] = trotter[19] * U(2,1,([i, j], 1), ([i, j], 0))
                trotter[19] = trotter[19] * U(2, 1, ([i-1, j], 0), ([i, j-1], 1))
...
for i in rangex:
    for j in rangey:
        if diagonal(i, j)[2]:
            ...
            ops.append((
                (
                    LGT_notation([i, j], 0),   # Z on this link
                    LGT_notation([i, j], 1),   # Y on this link
                ),
                "ZY",
                "black"
            ))
